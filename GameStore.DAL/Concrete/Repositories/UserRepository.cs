...
namespace GameStore.DAL.Concrete.Repositories
{
    public class UserRepository : IRepository<User>
    {
        ...
        public IEnumerable<User> GetMany(System.Linq.Expressions.Expression<Func<User, bool>> predicate)
        {
        ...
        public bool IsExists(System.Linq.Expressions.Expression<Func<User, bool>> predicate)
        {
