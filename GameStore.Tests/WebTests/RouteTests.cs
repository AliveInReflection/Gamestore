...
namespace GameStore.Tests.WebTests
{
    ...
    public class RouteTests
    {
        ...
        {
            RouteAssert.HasRoute(routes, "/en/games/new",
        ...
        {
            RouteAssert.HasRoute(routes, "/en/games/update",
        ...
        {
            RouteAssert.HasRoute(routes, "/en/game/gamekey",
        ...
        {
            RouteAssert.HasRoute(routes, "/en/games",
                new { controller = "Game", action = "Index"});
        }
        ...
        {
            RouteAssert.HasRoute(routes, "/en/game/gamekey/newcomment",
        ...
        {
            RouteAssert.HasRoute(routes, "/en/game/gamekey/comments",
        ...
        {
            RouteAssert.HasRoute(routes, "/en/game/gamekey/download",
        ...
        {
            RouteAssert.HasRoute(routes, "/en/publisher/new",
        ...
        {
            RouteAssert.HasRoute(routes, "/en/basket",
        ...
        {
            RouteAssert.HasRoute(routes, "/en/game/gameKey/buy",
